...
function customEffects(PanelId: number, WertR: number, WertG: Number, WertB: number, duration: number, mode: "one" | "all") {
    ...
    if (mode == "one") {
        ...
        const oldR_3 = client.getPanelColor(shuffeldPanel[1]).red
        const oldG_3 = client.getPanelColor(shuffeldPanel[1]).green
        const oldB_3 = client.getPanelColor(shuffeldPanel[1]).blue

        const oldR_4 = client.getPanelColor(shuffeldPanel[1]).red
        const oldG_4 = client.getPanelColor(shuffeldPanel[1]).green
        const oldB_4 = client.getPanelColor(shuffeldPanel[1]).blue

        const oldR_5 = client.getPanelColor(shuffeldPanel[1]).red
        const oldG_5 = client.getPanelColor(shuffeldPanel[1]).green
        const oldB_5 = client.getPanelColor(shuffeldPanel[1]).blue

        const oldR_6 = client.getPanelColor(shuffeldPanel[1]).red
        const oldG_6 = client.getPanelColor(shuffeldPanel[1]).green
        const oldB_6 = client.getPanelColor(shuffeldPanel[1]).blue

        const oldR_7 = client.getPanelColor(shuffeldPanel[1]).red
        const oldG_7 = client.getPanelColor(shuffeldPanel[1]).green
        const oldB_7 = client.getPanelColor(shuffeldPanel[1]).blue

        const oldR_8 = client.getPanelColor(shuffeldPanel[1]).red
        const oldG_8 = client.getPanelColor(shuffeldPanel[1]).green
        const oldB_8 = client.getPanelColor(shuffeldPanel[1]).blue

        const oldR_9 = client.getPanelColor(shuffeldPanel[1]).red
        const oldG_9 = client.getPanelColor(shuffeldPanel[1]).green
        const oldB_9 = client.getPanelColor(shuffeldPanel[1]).blue

        const oldR_10 = client.getPanelColor(shuffeldPanel[1]).red
        const oldG_10 = client.getPanelColor(shuffeldPanel[1]).green
        const oldB_10 = client.getPanelColor(shuffeldPanel[1]).blue

        const oldR_11 = client.getPanelColor(shuffeldPanel[1]).red
        const oldG_11 = client.getPanelColor(shuffeldPanel[1]).green
        const oldB_11 = client.getPanelColor(shuffeldPanel[1]).blue

        const oldR_12 = client.getPanelColor(shuffeldPanel[1]).red
        const oldG_12 = client.getPanelColor(shuffeldPanel[1]).green
        const oldB_12 = client.getPanelColor(shuffeldPanel[1]).blue

        const oldR_13 = client.getPanelColor(shuffeldPanel[1]).red
        const oldG_13 = client.getPanelColor(shuffeldPanel[1]).green
        const oldB_13 = client.getPanelColor(shuffeldPanel[1]).blue

        const oldR_14 = client.getPanelColor(shuffeldPanel[1]).red
        const oldG_14 = client.getPanelColor(shuffeldPanel[1]).green
        const oldB_14 = client.getPanelColor(shuffeldPanel[1]).blue
