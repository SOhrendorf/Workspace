...
Object.defineProperty(exports, "__esModule", ({ value: true }));
// Packages
const app_root_path_1 = __importDefault(__webpack_require__(/*! app-root-path */ "app-root-path"));
...
if (cwd !== app_root_path_1.default.path) {
    console.warn('[nodecg] process.cwd is %s, expected %s', cwd, app_root_path_1.default.path);
    process.chdir(app_root_path_1.default.path);
    console.info('[nodecg] Changed process.cwd to %s', app_root_path_1.default.path);
}
...
const config_1 = __webpack_require__(/*! ../config */ "./src/server/config/index.ts");
const ncgUtils = __importStar(__webpack_require__(/*! ../util */ "./src/server/util/index.ts"));
const BUILD_PATH = path_1.default.join(app_root_path_1.default.path, 'build/client');
const VIEWS_PATH = path_1.default.join(app_root_path_1.default.path, 'build/server/templates');
class DashboardLib {
    constructor(bundleManager) {
        ...
        app.use('/node_modules', express_1.default.static(path_1.default.join(app_root_path_1.default.path, 'node_modules')));
        app.get('/', (_, res) => {
...
const dbPath = path_1.default.join(app_root_path_1.default.path, 'db/nodecg.sqlite3');
...
const dataSource = new typeorm_1.DataSource({
    ...
    migrations: [path_1.default.join(app_root_path_1.default.path, 'build/typeorm/migration/**/*.js')],
    subscribers: [path_1.default.join(app_root_path_1.default.path, 'build/typeorm/subscriber/**/*.js')],
    migrationsRun: true,
    synchronize: false,
});
...
const BUILD_PATH = path_1.default.join(app_root_path_1.default.path, 'build/client/instance');
class RegistrationCoordinator {
    constructor(io, bundleManager, replicator) {
        ...
        this._instancesRep = replicator.declare('graphics:instances', 'nodecg', {
            schemaPath: path_1.default.resolve(app_root_path_1.default.path, 'schemas/graphics%3Ainstances.json'),
            persistent: false,
            defaultValue: [],
        });
...
function createMiddleware(callbacks) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const VIEWS_DIR = path_1.default.join(app_root_path_1.default.path, 'build/server/templates');
        app.use('/login', express_1.default.static(path_1.default.join(app_root_path_1.default.path, 'build/client/login')));
    ...
    start() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const bundlesReplicant = replicator.declare('bundles', 'nodecg', {
                schemaPath: path.resolve(app_root_path_1.default.path, 'schemas/bundles.json'),
                persistent: false,
            });
        ...
        bundles.forEach((bundle) => {
            ...
            if (bundle.soundCues.length > 0) {
                ...
                const cuesRep = replicator.declare('soundCues', bundle.name, {
                    schemaPath: path_1.default.resolve(app_root_path_1.default.path, 'schemas/soundCues.json'),
                    defaultValue: [],
                });
...
// Packages
const app_root_path_1 = __importDefault(__webpack_require__(/*! app-root-path */ "app-root-path"));
const pjsonPath = path_1.default.join(app_root_path_1.default.path, 'package.json');
        ...
        if (exports.ARRAY_MUTATOR_METHODS.includes(operation.method)) {
            ...
            switch (operation.method) {
                case 'overwrite': {
                    ...
                    this[process.env.BROWSER ? 'value' : '_value'] = proxyRecursive(this, newValue, operation.path);
                    result = true;
                    break;
                }
                case 'add':
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.stringifyErrorInner = exports.stringifyError = void 0;
